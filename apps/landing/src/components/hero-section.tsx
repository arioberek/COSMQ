...
export const HeroSection = () => {
	return (
		<section className="pt-24 md:pt-32 pb-24 px-6 text-center relative flex flex-col items-center overflow-hidden">
			<div className="relative z-10">
				...
				<motion.p
					...
					className="text-xl text-[#b8b8c8] max-w-[600px] mx-auto mb-10 leading-relaxed"
				>
