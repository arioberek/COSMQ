        ...
        >
          ...
          <XStack alignItems="center" padding="$md" gap="$md">
            ...
            >
              ...
              />
              <DatabaseIcon type={connection.type} size={28} color={theme.color.val} />
            </YStack>
            <YStack flex={1}>
              <Text color="$color" fontSize={17} fontWeight="600" letterSpacing={-0.2}>
                {connection.name}
              </Text>
              <Text color="$textSubtle" fontSize={13} marginTop="$xs" fontFamily="$mono">
      ...
      {connections.length === 0 ? (
        ...
        <>
          <Animated.View
            ...
            style={{ paddingHorizontal: 24, paddingTop: 120, paddingBottom: 16 }}
          >
            <Animated.Text
            ...
            <Link href="/connection/new" asChild>
              ...
              >
                ...
                <YStack
                  ...
                  opacity={0.3}
                />
                <Text color="#fff" fontSize={32} fontWeight="300" marginTop={-2}>
                  +
                </Text>
              </Pressable>
            </Link>
